...
가급적 한글로 서술하십시오. 한자는 간지(甲乙丙丁戊己庚辛壬癸 + 子丑寅卯辰巳午未申酉戌亥) 표기에만 사용합니다.
그 외 한자(宮通鑑, 透出, 得令 등)는 모두 한글로 쓰십시오.

간지 병기 시 단어 단위로 묶어 1회만 한글을 붙이십시오.

- ✅ "임수 일간이 유월 금왕지에서" — 한글만으로 충분한 경우
- ✅ "丙寅(병인)년, 丁酉(정유)월" — 간지 표기가 필요한 경우
- ✅ "갑목 편인이 투출하여"
- ❌ "壬(임)水(수)" — 글자마다 끊지 마십시오
- ❌ "壬水(임수) 일간이 酉(유)월" — 과도한 한자 사용
`;
