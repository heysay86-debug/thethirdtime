...
Codex API를 통해 해석·대화 인터랙션을 제공한다.
...
3. **명리학 이론 기준**: 이석영『사주첩경』을 계산 및 격국·용신 판단의 1차 기준으로 삼는다.
   ...
   상세: `docs/saju-engine-spec.md`, `docs/interpretation-policy.md`, `.Codex/commands/` 내 사주 커맨드 파일
...
| 사주 해석·명리학 | `.Codex/commands/saju-individual.md`, `saju-gungham.md` |
| UI·디자인 관련 | `DESIGN.md` |
